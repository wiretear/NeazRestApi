...
/*
	...
	@Autowired
	public void setNamedParameterJdbcTemplate(JdbcTemplate jdbcTemplate) throws DataAccessException {
	 ...
	 try {
		 user = jdbcTemplate.query("SELECT * FROM USERS",new BeanPropertyRowMapper<User>(User.class));   
	 ...
	 public int deleteUser(int id) {
		  int count = jdbcTemplate.update("DELETE from USERS WHERE employee_id = ?", new Object[] { id});
		  return count;
		 }
